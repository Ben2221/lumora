...
export const trendingMovies: MediaItem[] = [
  ...
  },
  {
    ...
    poster_path: "https://image.tmdb.org/t/p/w500/qJ2tW6WMUDux911r6m7haRef0WH.jpg", // The Dark Knight fallback
...
export const heroMovie: MediaItem = trendingMovies[0]; // Interstellar
...
export const newReleases: MediaItem[] = [
  {
    ...
    poster_path: "https://image.tmdb.org/t/p/w500/gEU2QniE6E77NI6lCU6MxlNBvIx.jpg", // Interstellar fallback
  ...
  },
  {
    ...
    poster_path: "https://image.tmdb.org/t/p/w500/oYuLEt3zVCKq57qu2F8dT7NIa6f.jpg", // Inception fallback
...
export const lumoraOriginals = [...newReleases].reverse();
